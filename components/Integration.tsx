  ...
  return (
    <div className="space-y-6">
       <header className="mb-6">
        <h1 className="text-3xl font-bold text-[#0B3B2E]">Integration Planning</h1>
        <p className="text-gray-600">Standardized Ops workflows for upcoming sites.</p>
      </header>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="space-y-6">
          <h2 className="text-xl font-bold text-[#0B3B2E] flex items-center gap-2">
        ...
        <div>
           <h2 className="text-xl font-bold text-[#0B3B2E] mb-4 flex items-center gap-2">
            ...
            {integrationDeals.map((deal, idx) => (
              <div key={idx} className="bg-white p-5 rounded-lg shadow-sm border border-gray-200">
                <div className="flex justify-between items-start mb-3">
                  <h3 className="font-bold text-lg text-[#0B3B2E]">{deal.deal_name}</h3>
                  <span className="text-xs font-medium px-2 py-1 bg-[#00A86B] text-white rounded">
                    {deal.status}
                  </span>
                </div>
                ...
                <button className="mt-4 w-full text-center py-2 border border-gray-300 rounded text-sm font-medium hover:bg-gray-50 text-[#0B3B2E]">
